      ...
      <div className="card w-[1430px] flex flex-wrap gap-6 mx-[85px] my-[50px]">
        {
          DATA.map((item, index) => {
            return (
              <div className="tavar w-[250px] h-[350px] border rounded-xl overflow-hidden" key={index}>
                ...
                <div className="qwerty flex gap-3 ml-[30px] my-[10px]">
                  ...
                  <span className='w-[100px] h-[25px] bg-[#d2cece75] text- font-bold text-[black]  rounded-2xl flex items-center justify-center'>{item.people}</span>
                </div>
